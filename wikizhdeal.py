...
with codecs.open(r"C:\Users\RY\Desktop\wiki.txt","r","utf-8") as f1,\
codecs.open(r"C:\Users\RY\Desktop\wiki_positive.txt","w","utf-8") as f2,\
codecs.open(r"C:\Users\RY\Desktop\wiki_negative.txt","w","utf-8") as f3,\
codecs.open(r"C:\Users\RY\Desktop\train.txt","w","utf-8") as f4,\
codecs.open(r"C:\Users\RY\Desktop\valid.txt","w","utf-8") as f5,\
codecs.open(r"C:\Users\RY\Desktop\test.txt","w","utf-8") as f6:
    data=[]
    for line in f1:
        i = 0
        line=line.strip()
